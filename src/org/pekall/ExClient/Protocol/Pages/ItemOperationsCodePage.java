...
public class ItemOperationsCodePage extends CodePage {
    ...
    public ItemOperationsCodePage() {
        ...
        codepageTokens.put("UserName", 0x14);
        codepageTokens.put("Password", 0x15);
        codepageTokens.put("Move", 0x16);
        codepageTokens.put("DstFldId", 0x17);
        codepageTokens.put("ConversationId", 0x18);
        codepageTokens.put("MoveAlways", 0x19);
