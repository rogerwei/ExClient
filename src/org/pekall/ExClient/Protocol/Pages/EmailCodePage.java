...
public class EmailCodePage extends CodePage {
    ...
    public EmailCodePage() {
        ...
        codepageTokens.put("Type", 0x29);
        codepageTokens.put("Until", 0x2a);
        codepageTokens.put("Occurrences", 0x2b);
        codepageTokens.put("Interval", 0x2c);
        codepageTokens.put("DayOfWeek", 0x2d);
        codepageTokens.put("DayOfMonth", 0x2e);
        codepageTokens.put("WeekOfMonth", 0x2f);
        codepageTokens.put("MonthOfYear", 0x30);
        ...
        codepageTokens.put("DisallowNewTimeProposal", 0x3F);
