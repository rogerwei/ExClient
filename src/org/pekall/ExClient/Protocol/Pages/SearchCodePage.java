...
public class SearchCodePage extends CodePage {
    ...
    public SearchCodePage() {
        ...
        codepageTokens.put("GreaterThan", 0x1B);
        codepageTokens.put("UserName", 0x1E);
        codepageTokens.put("Password", 0x1F);
        codepageTokens.put("ConversationId", 0x20);
        codepageTokens.put("Picture", 0x21);
        codepageTokens.put("MaxSize", 0x22);
        codepageTokens.put("MaxPictures", 0x23);
