package org.pekall.ExClient.Protocol.Pages;
...
public class CalendarCodePage extends CodePage {
    ...
    public CalendarCodePage() {
        ...
        codepageTokens.put("DisallowNewTimeProposal", 0x33);
        codepageTokens.put("ResponseRequested", 0x34);
        codepageTokens.put("AppointmentReplyTime", 0x35);
        codepageTokens.put("ResponseType", 0x36);
        codepageTokens.put("CalendarType", 0x37);
        codepageTokens.put("IsLeapMonth", 0x38);
        codepageTokens.put("FirstDayOfWeek", 0x39);
        codepageTokens.put("OnlineMeetingConfLink", 0x3A);
        codepageTokens.put("OnlineMeetingExternalLink", 0x3B);
