...
public class AirSyncCodePage extends CodePage {
    ...
    public AirSyncCodePage() {
        ...
        codepageTokens.put("ConversationMode",0x27);
        codepageTokens.put( "MaxItems",0x28);
        codepageTokens.put("HeartbeatInterval",0x29);
        ...
        codepageStrings.put(0x27, "ConversationMode");
        codepageStrings.put(0x28, "MaxItems");
        codepageStrings.put(0x29, "HeartbeatInterval");
